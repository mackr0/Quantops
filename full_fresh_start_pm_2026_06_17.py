"""Full FRESH-START for the EXP-A* experiment (2026-06-17, PM rev).
...
Run:
    cd /opt/quantopsai
    venv/bin/python full_fresh_start_pm_2026_06_17.py            # dry-run
    venv/bin/python full_fresh_start_pm_2026_06_17.py --apply    # execute
"""
...
NEW_KEYS = [
    ...
    ("A1", "6-17-acct-1.1", "PKYC3MJOFOZBX2HKFH4BGAEXBM",
        "3H9CYHVw72PYXucqbai1uxCBTrfKbYrcENfEjVK3AcLZ"),
    ("A2", "6-17-acct-2.1", "PKM7W62ZIATDHPITLXAN7GTXZT",
        "8vx1Z2FCJ23rf7Kc3UxhKzvebQmcnpkLs52K7PBnJLq8"),
    ("A3", "6-17-acct-3.1", "PKJMR6NFMTSO7KGHTESZGRRVND",
        "EQWqCyBorG9onJcddnVUsx89mXcwij4egPkJJHPFfU7H"),
]
...
def main() -> int:
    ...
    args = ap.parse_args()
    print("=" * 70)
    print(f"FULL FRESH-START 2026-06-17 PM rev / 2nd reset (apply={args.apply})")
    print("=" * 70)
    if not args.apply:
        print(
