"""Full FRESH-START for the EXP-A* experiment (2026-06-12).
...
to proceed if any key fails auth, equity != $1M, or n_positions != 0.
  ...
  A1 = 6-12-acct-1 (PKJCUMCT...)
  A2 = 6-12-acct-2 (PKWDGKKX...)
  A3 = 6-12-acct-3 (PKFSAVML...)

Run:
    cd /opt/quantopsai
    venv/bin/python full_fresh_start_2026_06_12.py            # dry-run
    venv/bin/python full_fresh_start_2026_06_12.py --apply    # execute
"""
...
NEW_KEYS = [
    # 2026-06-12 (sixth-reset rev) — fresh paper-trading Alpaca
    # accounts (6-12 generation; the 6-10 `.2` accounts are being
    # deleted at Alpaca.com so nothing holds positions outside our
    # system). $1M each. Step1_verify_keys auth-checks + confirms
    # equity and 0 positions before any destructive writes happen.
    ("A1", "6-12-acct-1", "PKJCUMCTY3RSJAZLKVXPIX7RGU",
        "84yenbZqutFG6koY1vFU8YGyeA2SYAzkgvC5TCvA12xr"),
    ("A2", "6-12-acct-2", "PKWDGKKXUGDI7BOOUARVRYPAAV",
        "EznXyDZmM7KrTLvnhZQR9w7jt2VEDGjdpfin4KsZjhEH"),
    ("A3", "6-12-acct-3", "PKFSAVMLXZIOGCUM2YVFOWKBCZ",
        "2Ptyv7FaC9cnYukrAyvTjmv2hzTgfbi72xGKYVAabj9b"),
]
...
def main() -> int:
    ...
    args = ap.parse_args()
    print("=" * 70)
    print(f"FULL FRESH-START 2026-06-12 (apply={args.apply})")
    print("=" * 70)
    if not args.apply:
        print(
