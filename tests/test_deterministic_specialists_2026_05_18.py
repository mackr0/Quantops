...
_FIRE_CASES = [
    ...
    # end_of_quarter_window, turn_of_month_strength, monday_morning_open,
    # last_30_min_session, first_5_min_session, wednesday_strength,
    # friday_close_caution, strong_volume_late_session.
]
