"""CAUTION LONG on bearish earnings-call transcript sentiment."""
from __future__ import annotations
from typing import Any, Dict, Optional

NAME = "transcript_sentiment_bearish"
DESCRIPTION = "CAUTION LONG on bearish transcript tone"
...
def evaluate(candidate: Dict[str, Any], ctx: Any = None) -> Optional[Dict[str, Any]]:
    ...
    if tone not in ("bearish", "negative", "cautious", "worried"):
        return None
