"""Full FRESH-START for the EXP-A* experiment (2026-06-30).

Why this script exists
----------------------
TWELFTH reset (2026-06-30). Cloned from full_fresh_start_2026_06_29.py and
...
NEW keys to install (paper-trading Alpaca accounts created 2026-06-30
...
to proceed if any key fails auth, equity != $1M, or n_positions != 0.
  ...
  A1 = 6-30-acct-1 (paste key) — must verify $1M / 0 positions, mult=4
  A2 = 6-30-acct-2 (paste key) — must verify $1M / 0 positions, mult=4
  A3 = 6-30-acct-3 (paste key) — must verify $1M / 0 positions, mult=4

Run:
    cd /opt/quantopsai
    venv/bin/python full_fresh_start_2026_06_30.py            # dry-run
    venv/bin/python full_fresh_start_2026_06_30.py --apply    # execute
"""
...
NEW_KEYS = [
    ...
    ("A1", "6-30-acct-1", "PKWRXPFWDSY6HLKWKIFZUCOM3K",
        "7Nrem5B2f7RkVPVTBSPRZDex8Rjv6KGcPgko8X1wHWNc"),
    ("A2", "6-30-acct-2", "PKTDUEK2SFDWHICSJEYZHBS577",
        "EKSTHbMCPvLFCKv8AhuuBbyFpQk7MZ2dZ6gFkWzNrjVP"),
    ("A3", "6-30-acct-3", "PKEGVIOHZJIFDT2J4ZDM3VZGNT",
        "D1jGwxCK1npb7WMzrnFeZbeNF9AyzwgA6LmfKKFKrhCy"),
]
...
def main() -> int:
    ...
    args = ap.parse_args()
    print("=" * 70)
    print(f"FULL FRESH-START 2026-06-30 / 12th reset (apply={args.apply})")
    print("=" * 70)
    if not args.apply:
        print(
