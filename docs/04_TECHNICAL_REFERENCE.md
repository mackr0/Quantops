...
Source: `tests/`. 574 test files covering:
...
- 7,036 tests, zero skipped (runtime `pytest.skip()` guards were systematically removed 2026-06-24; a structural guard now blocks broad-`except`→`skip`).
