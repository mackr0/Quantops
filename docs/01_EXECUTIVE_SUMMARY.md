...
1. **Test discipline.** 3,963 tests pass (1 skipped — an `_EMPTY_FIRE_EXEMPT` rule whose purpose IS to fire on minimal context). Test skips were systematically removed; new skips are blocked at code review.
